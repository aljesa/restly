    ...
    state: () => ({
        news: {
           items: [
            ...
            categories: [
                {
                    id: 1, title: 'Business Strategy', qty: 10,
                },
                {
                    id: 2, title: 'Investment Planning', qty: 5,
                },
                {
                    id: 3,
                    title: 'Financial Investment', qty: 3
                },
                {
                    id: 4,
                    title: 'Software Development', qty: 30,
                },
                {
                    id: 5,
                    title: 'Team Benefits', qty: 10
                }
            ]
        },
    })
